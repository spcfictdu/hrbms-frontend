    ...
    <v-row v-if="show" class="mx-3 text-subtitle-2">
      ...
      <v-col cols="12" sm="6" md="4">
        ...
        >
          ...
          >
            <v-btn color="primary" block @click="clearDate('Check In')">Clear</v-btn>
          </v-date-picker>
        </v-menu>
      </v-col>
      <v-col cols="12" sm="6" md="4">
        ...
        >
          ...
          >
            <v-btn color="primary" block @click="clearDate('Check Out')">Clear</v-btn>
          </v-date-picker>
        </v-menu>
      </v-col>
    </v-row>
  ...
  watch: {
    ...
    query_params: {
      ...
      handler: function (newVal) {
        let query = ["firstName", "middleName", "lastName", "referenceNumber", "checkInDate", "checkOutDate"];
